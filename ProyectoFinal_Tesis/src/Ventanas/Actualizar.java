 ...
 * @author cgcr1
 */
public final class Actualizar extends javax.swing.JFrame {
    ...
    void actualizar(){
        if (correcto == true){
            String d = jTextField2.getText(); //descripcion
            String m = jTextField3.getText(); //marca
            int c = Integer.parseInt(jTextField4.getText()); //cantidad
            Double p = Double.parseDouble(jTextField5.getText()); //precio
            String n = jTextField1.getText(); //numero
            String sql = "UPDATE products SET descripcion = ?, marca = ?, cantidad = ?, precio = ? "
                    + "WHERE id = ?";
            try{
    ...
    private void initComponents() {
        ...
        jButton1.setText("Mostrar datos del producto");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (busca == true){
            if (correcto == true){
                int n = JOptionPane.showConfirmDialog(null, "Está a punto de actualizar el producto. ¿Está seguro?", "Confirmar actualización", JOptionPane.YES_NO_OPTION);
            ...
            JOptionPane.showMessageDialog(this, "Primero debe mostrar los datos o ingresar el numero del producto.");
            jTextField1.requestFocus();
        }
